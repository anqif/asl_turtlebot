...
# starting at corner near gate
current_plan = [[3.4, 0.4,], [2.4, 0.25], [0.4, 0.4], [0.4, 2.5], [2.5, 2.5],[2.0, 1.6], [0.4, 1.6], [0.3, 2.4], [3.3, 2.7], [3.14, 1.6]]

# starting at the garage


# Construst PoseStamped() style pose_goal list 
expl_poses = [];
